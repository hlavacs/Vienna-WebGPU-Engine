...
class WebGPUMaterial : public WebGPURenderObject<engine::rendering::Material>
{
  public:
	 ...
	 */
	WebGPUMaterial(WebGPUContext &context, const engine::rendering::Material::Handle &materialHandle, wgpu::BindGroup bindGroup, wgpu::Buffer propertiesBuffer, WebGPUMaterialTextures textures, WebGPUMaterialOptions options = {});
