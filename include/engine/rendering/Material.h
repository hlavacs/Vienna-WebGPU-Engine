				  ...
				  public engine::core::Versioned
{
	...
	Material(const MaterialProperties &props, TextureHandle albedoTex = {}, TextureHandle normalTex = {}, TextureHandle metallicTex = {}, TextureHandle roughnessTex = {}, TextureHandle aoTex = {}, TextureHandle emissiveTex = {}, TextureHandle opacityTex = {}, TextureHandle specularTex = {}) :
		properties(props),
